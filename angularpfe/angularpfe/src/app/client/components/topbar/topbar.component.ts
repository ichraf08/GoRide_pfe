...
export class TopbarComponent implements OnInit {
  ...
  getPageTitle(): string {
    ...
    if (url.includes('home')) return 'Tableau de bord';
    if (url.includes('book-ride')) return 'Commander un trajet';
    if (url.includes('rent-vehicle')) return 'Louer un véhicule';
    if (url.includes('my-bookings')) return 'Mes réservations';
